...
from src.sources.lyrics.Mock import Mock as LyricsMock
from src.sources.media.Mock import Mock as MediaMock
from src.sources.songs.Mock import Mock as SongMock
...
def main():
    ...
    lyric_sources = {
        ...
        LyricsMock.__class__:LyricsMock(user_args),
    }
    ...
    song_sources = {
        ...
        SongMock.__class__:SongMock(user_args)
    }

    media_sources = {
        #Youtube.__class__:Youtube(user_args),
        MediaMock.__class__:MediaMock(user_args)
    }
